...
- Create Angular project with ng: `ng new taskmanager.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `taskmanager.client.esproj`).
